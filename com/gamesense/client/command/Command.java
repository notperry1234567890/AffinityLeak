...
public abstract class Command {
  ...
  public static void sendClientMessage(String message) {
    ...
    if (Notifications.disableChat.getValue() && ModuleManager.isModuleEnabled("Notifications"))
      return; 
    if (MsgWaterMark) {
      mc.player.sendMessage((ITextComponent)new TextComponentString(ChatFormatting.AQUA + "[" + ChatFormatting.WHITE + "Affinity" + ChatFormatting.RED + "+" + ChatFormatting.AQUA + "] " + ChatFormatting.RESET + cf + message));
    } else {
