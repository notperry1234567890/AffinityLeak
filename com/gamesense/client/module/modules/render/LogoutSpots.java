...
public class LogoutSpots extends Module {
  ...
  public void setup() {
    ...
    this.color = registerColor("Box Color", "Color", new APColor(0, 0, 0));
    this.nameColor = registerColor("Nametag Color", "NameColor");
  }
  ...
  public void onWorldRender(RenderEvent event) {
    this.loggedPlayers.forEach((e, time) -> {
          if (mc.player.getDistance(e) < 500.0F) {
            GL11.glPushMatrix();
            drawLogoutBox(e.getRenderBoundingBox(), this.width.getValue());
            drawNametag(e, time);
            GL11.glPopMatrix();
          } 
        });
  ...
  public void drawLogoutBox(AxisAlignedBB bb, int width) {
    GameSenseTessellator.drawBoundingBox(bb, width, this.color.getValue());
  }
  ...
  private void drawNametag(Entity entityIn, String t) {
    ...
    fontRendererIn.drawStringWithShadow(line1, -i, 10.0F, this.nameColor.getValue().getRGB());
    fontRendererIn.drawStringWithShadow(line2, -ii, 20.0F, this.nameColor.getValue().getRGB());
